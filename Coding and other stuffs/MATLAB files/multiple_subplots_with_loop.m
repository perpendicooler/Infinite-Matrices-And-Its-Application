function multiple_subplots_with_loop()
    number_of_terms = 100;
    tolerance = 1e-10;
    matrixSize = 10;
    num_eigenvalues = 25;
    ...
    while eigenvalue_counter <= num_eigenvalues
        % Determine the range of eigenvalues for the current figure
        eigenvalue_start = eigenvalue_counter;
        eigenvalue_end = min(eigenvalue_counter + num_subplots_per_figure - 1, num_eigenvalues);
        ...
        for subplotIdx = 1:num_subplots_per_figure
            ...
            % Loop through eigenvalues for each subplot
            for eigenIdx = eigenvalue_start:eigenvalue_end
            ...
            title(sprintf('Convergence of Determinant Error for Eigenvalues %d to %d', eigenvalue_start, eigenvalue_end));
        ...
        eigenvalue_counter = eigenvalue_counter + num_subplots_per_figure;
    end
end
