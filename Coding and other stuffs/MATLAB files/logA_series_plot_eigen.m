function logA_series_plot_eigen()
    number_of_terms = 1000;
    tolerance = 1e-6;  % Set the desired threshold for convergence
    ...
    figure;
    scatter(real(eigenvalues_A), imag(eigenvalues_A), 'Marker', 'o', 'MarkerEdgeColor', 'b', 'DisplayName', 'Eigenvalues');
    xlabel('Real Part');
    ylabel('Imaginary Part');
    title('Real Eigenvalues of Matrix A');
